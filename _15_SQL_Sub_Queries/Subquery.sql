...
-- ------------------------------ SubQueries ------------------------------
-- WHERE -------
-- 1. Find students who scored more marks than average marks
...
-- 1.2. By using subquery, find student/s who scored more marks than average marks
SELECT name, marks
FROM students
WHERE marks > (
	SELECT AVG(marks)
...
-- NOTE : Subqueries are most commonly used in the WHERE clause. Subqueries in FROM and SELECT are also used, but less frequently in basic queries.